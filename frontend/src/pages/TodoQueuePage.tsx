...
export function TodoQueuePage() {
  ...
  const pendingItems = items.filter((i) => i.queue_status === 'pending' && !hiddenIds.has(i.id))
  ...
  return (
    <div className="p-6">
      ...
      {loading && pendingItems.length === 0 ? (
        ...
        <EmptyState
          icon="📭"
          title="Keine ausstehenden Vorschläge"
          description="Neue Items erscheinen automatisch aus Email- und Chat-Analyse wenn diese aktiviert sind."
          size="spacious"
        />
      ) : (
